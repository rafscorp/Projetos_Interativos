...
export const projects = [
  {
    ...
    tipo: 'wasm',
    ferramenta: 'compilado com Emscripten (WASM) — rodando de verdade',
  ...
  },
  {
    ...
    tipo: 'pyodide',
    ferramenta: 'rodando com Pyodide — de verdade',
  ...
  },
  {
    ...
    tipo: 'cheerpj',
    ferramenta: 'rodando com CheerpJ — de verdade',
    jarPath: 'java/Calculadora.jar',
  ...
  },
  {
    ...
    tipo: 'cheerpj',
    ferramenta: 'rodando com CheerpJ — de verdade',
    jarPath: 'java/SistemaEstoque.jar',
    isConsoleApp: true,
    arquivos: [
